%A3WDAG1-EX1 is an experiments on Algorithm 1
...
% ca: limited action cost
% c_step: step for drawing the line (used in inferring the corresponding benefit)

function [c_list,b_list]=A3WD2_EX1(data,label,stb_v,lambda_mx,ca,c_step,ForC,style)
tic
